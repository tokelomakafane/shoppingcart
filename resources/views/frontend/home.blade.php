...
@section('content')
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url({{ (!empty($slider->image))? url('upload/'.$slider->image):url('upload/no_image.jpg') }});">
    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="{{ (!empty($product->image))? url('upload/'.$product->image):url('upload/no_image.jpg') }}" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
